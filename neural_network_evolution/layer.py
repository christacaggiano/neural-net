...
import numpy as np
import copy
from neural_network_evolution.activation_functions import Sigmoid, ReLU, SoftPlus, LeakyReLU
from neural_network_evolution.activation_functions import TanH, ELU, SELU, Softmax
